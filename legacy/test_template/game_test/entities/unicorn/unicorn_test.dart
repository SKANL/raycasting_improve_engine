...
import 'package:raycasting_game/game/entities/unicorn/behaviors/behaviors.dart';
...
class _RaycastingGame extends RaycastingGame {
  _RaycastingGame({
    required super.l10n,
...
void main() {
  ...
  group('Unicorn', () {
    ...
    _RaycastingGame createFlameGame() {
      return _RaycastingGame(
        l10n: l10n,
